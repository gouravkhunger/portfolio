...
date: 2021-09-16
description: "The complete guide to learn how to create an app using Android Studio IDE."
image: "/assets/images/blog/how-to-create-your-first-android-app-using-android-studio/thumbnail.webp"
category: "android"
tags:
  - "app-development"
  - "beginners"
...
![Welcome to Android Studio Screen](/assets/images/blog/how-to-create-your-first-android-app-using-android-studio/welcome-to-android-studio-screen.webp)
...
![New Project Button](/assets/images/blog/how-to-create-your-first-android-app-using-android-studio/new-project-button.webp)

Pressing it will take you to the New Project window.

![New Project Window](/assets/images/blog/how-to-create-your-first-android-app-using-android-studio/new-project-window.webp)
...
![Select Empty Activity From Prebuilt Templates](/assets/images/blog/how-to-create-your-first-android-app-using-android-studio/select-empty-activity-from-prebuilt-templates.webp)

Press the next button. Now you will be asked to give some information about the android app. 

![Give information to Android Studio about your app](/assets/images/blog/how-to-create-your-first-android-app-using-android-studio/give-information-to-android-studio-about-your-app.webp)
...
![Finish button in New Project Window - Android Studio](/assets/images/blog/how-to-create-your-first-android-app-using-android-studio/finish-button-in-new-project-window-android-studio.webp)
...
![Android Studio IDE Project Screen Image](/assets/images/blog/how-to-create-your-first-android-app-using-android-studio/android-studio-ide-project-screen-image.webp)

[In the last article](/posts/beginning-android-development-with-android-studio#emulators-yes-or-no), I explained whether or not you should use emulators or not. In this article, I will run the app on my device but you can also use 
...
![Connected Devices in Android Studio](/assets/images/blog/how-to-create-your-first-android-app-using-android-studio/connected-devices-in-android-studio.webp)
...
![Build and run an Android app on a real device - Android Studio](/assets/images/blog/how-to-create-your-first-android-app-using-android-studio/build-and-run-an-android-app-on-a-real-device-android-studio.gif)

...
date: 2022-04-24
description: "The complete guide to paginating *just* a room database (without Network level pagination) with the Paging 3 library in Android using Kotlin."
image: "/assets/images/blog/pagination-in-android-room-database-using-the-paging-3-library/thumbnail.webp"
category: "android"
tags:
  - "intermediates"
  - "app-development"
...
<a href="https://github.com/gouravkhunger/room-paging3-demo" class="link-card">
  <span class="link-card-title">gouravkhunger/paging3-room-demo</span>
...
<div class="video">
  <iframe src="https://www.youtube.com/embed/D-vw0ITD9Ww" title="YouTube video" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen loading="lazy"></iframe>
</div>
...
<a href="https://genicsblog.com/how-to-create-your-first-android-app-using-android-studio" class="link-card">
  <span class="link-card-title">genicsblog.com</span>
  <span class="link-card-host">genicsblog.com</span>
</a>
...
![Files to be added to the project](/assets/images/blog/pagination-in-android-room-database-using-the-paging-3-library/files-to-be-added-to-the-project.webp)
...
![Demo of the application we will build](/assets/images/blog/pagination-in-android-room-database-using-the-paging-3-library/demo-of-the-application-we-will-build.webp){:width="40%"}

...
date: 2022-04-10
description: "Jekyll doesn't support multiple authors out of the box. But we can add that functionality using this plugin I made!"
image: "/assets/images/blog/adding-multiple-authors-to-a-jekyll-blog-got-easier/thumbnail.webp"
category: "jekyll"
tags:
  - "open-source"
  - "libraries"
...
There's a major issue of pagination with the above approach. For example, let's take [my profile](https://genicsblog.com/author/gouravkhunger) at Genics Blog. I've got tons of posts. Along with Each post has a thumbnail image associated with it.
...
I wished to integrate autopages for authors functionality to it, but the paginate-v2 plugin isn't being actively maintained. So I decided to build [`jekyll-auto-authors`](https://github.com/gouravkhunger/jekyll-auto-authors) that works in sync with it. Drop a star at GitHub to show support!

<a href="https://github.com/gouravkhunger/jekyll-auto-authors" class="link-card">
  <span class="link-card-title">gouravkhunger/jekyll-auto-authors</span>
...
<div class="video">
  <iframe src="https://www.youtube.com/embed/V5Ly6T_bWwU" title="YouTube video" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen loading="lazy"></iframe>
</div>

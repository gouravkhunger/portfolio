...
date: 2021-02-12
description: "Making accordions in Android can be hard, but here's an easy way to build them."
image: "/assets/images/blog/how-to-make-accordions-in-android/thumbnail.webp"
notice: |-
  **NOTE**: I have made an Android library called [AccoLib](http://github.com/gouravkhunger/accolib) that would be better suited to make accordions for an Android app. Please use the code in this article as a learning resource only. Using this code for making multiple accordions in the same activity can cause a laggy UX.
...
![accordion.gif](/assets/images/blog/how-to-make-accordions-in-android/accordion.gif)

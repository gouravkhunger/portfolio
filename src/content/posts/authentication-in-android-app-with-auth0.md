...
date: 2021-09-26
description: "The complete guide to integrating auth0 authentication in your Android app."
image: "/assets/images/blog/authentication-in-android-app-with-auth0/thumbnail.webp"
category: "android"
tags:
  - "authentication"
  - "app-development"
...
<div class="video">
  <iframe src="https://www.youtube.com/embed/obk3q1AaH6I" title="YouTube video" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen loading="lazy"></iframe>
</div>

The code for this basic app that we are going to build is present here on GitHub:

<a href="https://github.com/gouravkhunger/auth0-demo-android" class="link-card">
  <span class="link-card-title">gouravkhunger/auth0-demo-android</span>
  <span class="link-card-host">github.com</span>
</a>
...
First, create a new Android Studio Project.  If you are just checking out Auth0, you can follow the steps mentioned in [my previous article](/posts/how-to-create-your-first-android-app-using-android-studio) on how to make a basic project using Android Studio.
...
![Enable view binding in Android apps](/assets/images/blog/authentication-in-android-app-with-auth0/enable-view-binding-in-android-apps.webp)
...
![Adding auth0 sdk to android app](/assets/images/blog/authentication-in-android-app-with-auth0/adding-auth0-sdk-to-android-app.webp)
...
![strings.xml file in android](/assets/images/blog/authentication-in-android-app-with-auth0/strings-xml-file-in-android.webp)
...
![Android Studio Gradle sync notification](/assets/images/blog/authentication-in-android-app-with-auth0/android-studio-gradle-sync-notification.webp)
...
![Adding internet permission in AndroidManifest.xml file](/assets/images/blog/authentication-in-android-app-with-auth0/adding-internet-permission-in-androidmanifest-xml-file.webp)
...
![Basic user profile layout preview for demo Android app](/assets/images/blog/authentication-in-android-app-with-auth0/basic-user-profile-layout-preview-for-demo-android-app.webp){:width="50%"}
...
You can use any scheme name, here I used `demo`. I recommend not to use `https` because it might conflict with the intent-filters internally. I got this error while building [JekyllEx](/posts/introducing-jekyllex-android-app).
...
![Creating a new tenant in Auth0 dashboard](/assets/images/blog/authentication-in-android-app-with-auth0/creating-a-new-tenant-in-auth0-dashboard.webp)
...
![Creating a new app in auth0 dashboard](/assets/images/blog/authentication-in-android-app-with-auth0/creating-a-new-app-in-auth0-dashboard.webp)
...
![Settings tab of an app in Auth0](/assets/images/blog/authentication-in-android-app-with-auth0/settings-tab-of-an-app-in-auth0.webp)
...
![Auth0 allowed callbacks urls](/assets/images/blog/authentication-in-android-app-with-auth0/auth0-allowed-callbacks-urls.webp)

![Auth0 allowed login urls](/assets/images/blog/authentication-in-android-app-with-auth0/auth0-allowed-login-urls.webp)
...
[Let's connect](https://genicsblog.com/author/gouravkhunger) with each other :)

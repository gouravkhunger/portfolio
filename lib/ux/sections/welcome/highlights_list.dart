...
class _HighlightsListState extends AnimatableState<HighlightsList> {
  ...
  List<ContentViewModel> get welcomeScreenHighlights => [
        ...
        ContentViewModel(
          icon: Icons.web,
          title: AppLocalization.instance.highlightBlogger,
          description: AppLocalization.instance.highlightBlogDescription,
        ),
        ContentViewModel(
          icon: AppIcons.heart,
        ...
        ContentViewModel(
          icon: Icons.book,
          title: AppLocalization.instance.highlightStudentTitle,
          description: AppLocalization.instance.highlightStudentDescription,
        ),
        ContentViewModel(
          icon: Icons.sports_basketball,
          title: AppLocalization.instance.highlightGameTitle,
          description: AppLocalization.instance.highlightGameDescription,
        ),
      ];
